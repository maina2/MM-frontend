...
import { AuthContext } from "../context/AuthContext"; // Assume an AuthContext for user role

const Layout: React.FC = () => {
  const { user } = useContext(AuthContext); // Get user from context (assumed)
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <main
            className={`flex-1 ${
              isAdmin ? "md:ml-64" : ""
            } pt-[var(--mobile-nav-height)] md:pt-[var(--desktop-nav-height)] pb-16 md:pb-0 p-4 sm:p-6 max-w-7xl mx-auto w-full`}
          >
            <Outlet />
          </main>
