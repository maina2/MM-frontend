...
import { Package, Clock, User, Truck, CheckCircle, XCircle, MapPin, Filter, Eye, ChevronLeft, ChevronRight, Map } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold py-2 px-4 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all disabled:opacity-50"
        ...
        {paginatedDeliveries.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
            ...
            <p className="text-gray-600">
              {statusFilter === 'all' ? "You don't have any delivery tasks yet." : `No ${statusConfig[statusFilter]?.label?.toLowerCase()} tasks found.`}
            </p>
          </div>
        ) : (
          <>
                    ...
                    <div className="p-4 space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-900 font-medium">{delivery.delivery_address}</p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-900 font-medium">{formatDate(delivery.estimated_delivery_time)}</p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-900 font-medium">{delivery.order.customer?.username || 'N/A'}</p>
                        </div>
                      </div>
                      <div className="pt-4 border-t border-gray-100">
                        <button
                          onClick={() => navigate(`/delivery/tasks/${delivery.id}`)}
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1 rounded-lg text-sm font-medium transition-colors ${
                              isActive ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100'
                            }`}
                          >
                            {pageNum}
                          </button>
